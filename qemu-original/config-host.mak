...
# Configured with: './configure' '--enable-linux-aio' '--target-list=x86_64-softmmu' '--enable-kvm'
all:
prefix=/usr/local
bindir=${prefix}/bin
libdir=${prefix}/lib
...
libs_softmmu=-lutil -lcurl   -lncurses    -lpng12   -ljpeg -lgnutls   -lSDL   -lX11  -lz -laio  -lpixman-1  
ARCH=x86_64
...
VERSION=1.5.50
PKGVERSION=
SRC_PATH=/home/bcc/apz11/git/tg1/qemu-original
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/bcc/apz11/git/tg1/qemu-original/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
LDFLAGS=-Wl,--warn-common -Wl,-z,relro -Wl,-z,now -pie -m64 -g 
LIBTOOLFLAGS= -Wc,-fstack-protector-all
LIBS+=-lrt -pthread -lgthread-2.0 -lglib-2.0   
LIBS_TOOLS+=-lcurl    -laio
EXESUF=
