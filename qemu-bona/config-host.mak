...
# Configured with: './configure' '--enable-linux-aio' '--target-list=x86_64-softmmu' '--enable-kvm' '--enable-debug'
all:
prefix=/usr/local
bindir=${prefix}/bin
libdir=${prefix}/lib
...
libs_softmmu=-lutil -lncurses -ltinfo     -lz -laio  -lpixman-1  
ARCH=x86_64
